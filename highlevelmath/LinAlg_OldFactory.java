...
public class LinAlg_OldFactory<T, S, V extends Vec<T, S>, M extends Matx<T,S>> {
    ...
    //Constructor
    public LinAlg_OldFactory(VecFactory<T, V> vec, MatxFactory<V, M> mat, ArrFactory<T> arr, ArrFactory<V> vecArr, ArrFactory<M> matArr, TwoArrFactory<T> twoArr){
        this.vec = vec;
        this.mat = mat;
        this.arr = arr;
        this.vecArr = vecArr;
